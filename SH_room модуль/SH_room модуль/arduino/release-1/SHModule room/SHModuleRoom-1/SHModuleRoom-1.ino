...
void compil() {
  ...
  if (!IS_MOVE) {
    mes = "CiSHP-1m|t2|" + String(error_tupe) + "|" + String(warning) + "|" + String(temp) + "|" + String(higr) + "|" + String(is_client) + "|" + String(hour_start) + ":" + String(min_start) + ":" + String(sec_start) + "|" + String(rele1.is_on) + "," + String(rele2.is_on) + "," + String(rele3.is_on) + "," + String(rele4.is_on) + "," + String(rele5.is_on) + "," + String(rele6.is_on) + "," + String(rele7.is_on) + "," + String(rele8.is_on) + "|-1";
    Serial.println(mes);
  }
}
